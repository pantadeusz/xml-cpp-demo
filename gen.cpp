...
std::string entities_convert(const std::string &str) {
...
element_t str_to_element(const std::string &txt) {
  element_t ret;
...
tree_elem_t<element_t> text_to_xml(const std::string &xml_text) {
...
tree_elem_t<element_t> text_to_xml_with_entities(const std::string &xml_text) {
...
int main(int argc, char **argv) {
  ...
  std::cout << "-------------- A ----------" << std::endl;
  print_tree(string_to_tree(xml_text));
  std::cout << "-------------- B ----------" << std::endl;
